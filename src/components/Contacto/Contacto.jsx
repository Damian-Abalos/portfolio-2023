    ...
    <div className='text-center h-100'>
      <section id='contact'>
        ...
        <div className='contact-wrapper'>
          <form id='contact-form' className='form-horizontal' role='form' onSubmit={(e) => e.preventDefault()}>
            ...
            <textarea
              ...
              required
            ></textarea>
            <button className='btn btn-primary send-button' id='submit' onClick={enviarFormulario}>
...
//           <form id="contact-form" className="form-horizontal" role="form" action='servidor.php'>
